...
use alloy_primitives::{map::HashMap, Address, Bloom, Bytes, B256, U256};
...
/// Simplified transaction receipt structure matching the flashblock format
#[derive(Default, Debug, Clone, Eq, PartialEq, Serialize, Deserialize)]
...
pub struct Metadata {
    ...
    /// Transaction hash if available (some flashblock formats include this).
    ...
    pub receipts: HashMap<B256, SimpleReceipt>,
}
